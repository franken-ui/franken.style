...
<span class="uk-label uk-label-primary">Note</span> If you have installed or started your project using [FrankenstyleKit](/docs/latest/kit/installation), there's no need to install Frankenstyle separately, as it is already included in the package.

<Ec path="installation.css" />
