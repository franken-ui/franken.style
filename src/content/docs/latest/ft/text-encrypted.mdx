...
<script src="https://cdn.jsdelivr.net/npm/frankenstyle@0.3.4/dist/js/ft-core.iife.js"></script>
<script src="https://cdn.jsdelivr.net/npm/frankenstyle@0.3.4/dist/js/ft/text-encrypted.iife.js"></script>
