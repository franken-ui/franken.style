...
| Class                        | Description               |
| ---------------------------- | ------------------------- |
| `.uk-pagination-default`     | Adds the default style.   |
| `.uk-pagination-primary`     | Adds a primary style.     |
| `.uk-pagination-secondary`   | Adds a secondary style.   |
| `.uk-pagination-destructive` | Adds a destructive style. |
| `.uk-pagination-ghost`       | Adds a ghost style.       |
