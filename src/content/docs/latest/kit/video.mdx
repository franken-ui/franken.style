...
For example, the [Slideshow](/docs/2.1/slideshow#videos), [Lightbox](/docs/2.1/lightbox#content-sources) and [Cover](/docs/2.1/cover#video) components inherit and make use of both functions.
