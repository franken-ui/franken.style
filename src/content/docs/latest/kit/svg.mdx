---
context: https://codeberg.org/FRNKN/style/src/branch/master/contexts/kit/svg.md
group: components
project: kit
text: SVG
title: SVG
...
There are two ways to animate SVG strokes. First by using the [Animation component](/docs/latest/kit/animation#svg-strokes) and `data-uk-svg="stroke-animation: true"`, and second by using the [Parallax component](/docs/latest/kit/parallax#svg-strokes).
