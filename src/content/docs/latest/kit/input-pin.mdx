---
context: https://codeberg.org/FRNKN/style/src/branch/master/contexts/kit/input-pin.md
group: forms
project: kit
text: OTP / PIN
title: Input PIN
...
<Ec project="kit" path="input_pin.1" />
...
<Ec project="kit" path="input_pin.3" />
...
<Ec project="kit" path="input_pin.7" />

### Using JSON object format

Target specific elements with custom styles:

<Ec project="kit" path="input_pin.8" />

### Using configuration script

<Ec project="kit" path="input_pin.9" />
...
<Ec project="kit" path="input_pin.2" />
