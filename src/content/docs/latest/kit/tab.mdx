...
The Tab component consists of clickable tabs, that are aligned side by side in a list. Its JavaScript functionality extends the [Switcher component](/docs/2.1/switcher) and is necessary to dynamically transition through different contents using the tabbed navigation.
...
<Ec project="kit" path="tab.1" />

<Snippet project="kit" component="tab.basic" />

## Alternative layout

Use the `.uk-tab-alt` class for the alternative layout.

<Snippet project="kit" component="tab.alternative_layout" />

## Bottom modifier

Add the `.uk-tab-bottom` class to flip tab items to the bottom.

<Ec project="kit" path="tab.2" />

<Snippet project="kit" component="tab.bottom" />
...
When using the vertical alignment, you will usually create a grid to apply the layout as seen in the [Switcher example](/docs/2.1/switcher#vertical-tabs).

<Ec project="kit" path="tab.3" />

<Snippet project="kit" component="tab.left_right" />
...
<Ec project="kit" path="tab.4" />

## Alignment

You can combine tabs with the utility classes from Tailwind CSS to modify the alignment of the navigations.

<Ec project="kit" path="tab.5" />

<Snippet project="kit" component="tab.alignment" />

## Tabs and Dropdown

Tabs can be used to trigger a dropdown menu from the [Dropdown component](/docs/2.1/dropdown).

<Ec project="kit" path="tab.6" />

<Snippet project="kit" component="tab.dropdown" />
...
- The _tab navigation_ has the `tablist` role, and if it is a [Nav component](/docs/2.1/nav), the `aria-orientation` state set to `vertical`.
