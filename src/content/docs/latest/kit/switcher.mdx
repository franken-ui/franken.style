...
The switcher can also be applied to buttons or button groups from the [Button component](/docs/latest/kit/button). Just add the switcher attribute to a block around a group of buttons or to the element with the `.uk-btn-group` class.
