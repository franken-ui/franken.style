...
<Ec project="kit" path="switcher.1" />

In this example we are using the [Subnav component](/docs/2.1/subnav).

<Snippet project="kit" component="switcher.basic" />
...
<Ec project="kit" path="switcher.2" />

<Snippet project="kit" component="switcher.navigation_controls" />
...
<Ec project="kit" path="switcher.3" />

<Snippet project="kit" component="switcher.multiple_containers" />

## Animations

You can apply all animations from the [Animation component](/docs/2.1/animation) to switcher items. To do so, add the `animation` parameter with the relevant class to the `data-uk-switcher` attribute.

<Ec project="kit" path="switcher.4" />

<Snippet project="kit" component="switcher.animations" />

### Multiple animations

You can also apply multiple animations from the [Animation component](/docs/2.1/animation). That way you can add different in and out animations.

<Ec project="kit" path="switcher.5" />

<Snippet project="kit" component="switcher.multiple_animations" />

## Switcher and subnav

The switcher is easily applied to the [Subnav component](/docs/2.1/subnav).

<Ec project="kit" path="switcher.6" />

<Snippet project="kit" component="switcher.subnav" />

## Switcher and tab

As an exception to the rule, add the `data-uk-tab` attribute instead of `data-uk-switcher` to the tabbed navigation to combine the switcher with the [Tab component](/docs/2.1/tab).

<Ec project="kit" path="switcher.7" />

<Snippet project="kit" component="switcher.tab" />
...
<Ec project="kit" path="switcher.8" />

<Snippet project="kit" component="switcher.vertical_tabs" />

## Switcher and button

The switcher can also be applied to buttons or button groups from the [Button component](/docs/2.1/button). Just add the switcher attribute to a block around a group of buttons or to the element with the `.uk-btn-group` class.

<Ec project="kit" path="switcher.9" />

<Snippet project="kit" component="switcher.button" />
...
To apply the switcher to the [Nav component](/docs/2.1/nav), add the `data-uk-switcher` attribute to the nav `<ul>` element.

<Ec project="kit" path="switcher.10" />

<Snippet project="kit" component="switcher.nav" />
...
| `animation`   | String       | `false`              | Space-separated names of [animations](/docs/2.1/animation). Comma-separated for animation out.               |
...
<Ec project="kit" path="switcher.11" />
...
<Ec project="kit" path="switcher.12" />
...
<Ec project="kit" path="switcher.13" />
...
- The _toggle navigation_ has the `tablist` role, and if it is a [Nav component](/docs/2.1/nav), the `aria-orientation` state set to `vertical`.
