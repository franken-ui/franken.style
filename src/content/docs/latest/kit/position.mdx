...
There are two classes to center elements outside on the left and right of the parent container. This is useful to position the [Slidenav component](/docs/2.1/slidenav) outside of a [Slideshow](/docs/2.1/slideshow) or [Slider](/docs/2.1/slider) component.
