---
context: https://codeberg.org/FRNKN/style/src/branch/master/contexts/kit/breadcrumb.md
group: components
project: kit
text: Breadcrumb
title: Breadcrumb
...
<Ec project="kit" path="breadcrumb.1" />

<Snippet project="kit" component="breadcrumb.basic" />
...
<Ec project="kit" path="breadcrumb.2" />
