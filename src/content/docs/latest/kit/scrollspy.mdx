...
Typically, classes from the [Animation component](/docs/2.1/animation) are used together with the Scrollspy component.

<Ec project="kit" path="scrollspy.1" />

<Snippet project="kit" component="scrollspy.basic" />

This example uses the `repeat: true` option. Scroll up and down to see the triggered animations. The layout is made with the [Card component](/docs/2.1/card).
...
<Ec project="kit" path="scrollspy.2" />

<Snippet project="kit" component="scrollspy.groups" />
...
<Ec project="kit" path="scrollspy.3" />

<Snippet project="kit" component="scrollspy.groups_1" />
...
<Ec project="kit" path="scrollspy.4" />
...
<Ec project="kit" path="scrollspy.5" />
...
<Ec project="kit" path="scrollspy.6" />
...
| `scroll`  | Boolean               | `false`     | Adds the [Scroll component](/docs/2.1/scroll) to its links.       |
...
<Ec project="kit" path="scrollspy.7" />
