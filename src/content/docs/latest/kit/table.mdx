---
context: https://codeberg.org/FRNKN/style/src/branch/master/contexts/kit/table.md
group: components
project: kit
text: Table
title: Table
...
| Class                 | Description                                                                                                                                                                                                                                   |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.uk-table-link`      | To link an entire cell, add this class to a `<th>`or `<td>` element and insert an `<a>` element. Add the `.uk-link-reset`class from the [Link component](/docs/latest/kit/link) to reset the default link styling.                                   |
